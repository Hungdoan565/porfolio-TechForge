  ...
  return (
    <div
      className={cn(
        ...
        "relative flex h-36 w-[22rem] select-none flex-col justify-between rounded-xl border-2 bg-muted/70 backdrop-blur-sm px-4 py-3",
        ...
        // Z-index on hover to prevent flickering
        "hover:z-50",
        // Gradient overlay
    ...
    >
      ...
      <p className="whitespace-nowrap text-base text-slate-700 dark:text-slate-300">
        {description}
      </p>
...
export default function DisplayCards({ cards, className }: DisplayCardsProps) {
  ...
  return (
    <div
      className={cn(
        "grid [grid-template-areas:'stack'] place-items-center isolate",
        className,
      )}
    >
