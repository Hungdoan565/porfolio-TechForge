...
const TechIcons = {
    ...
    csharp: (
        <svg viewBox="0 0 128 128" className="w-full h-full">
            ...
            <path fill="#fff" d="M82 74h4v-8h8v-4h-8v-8h-4v8h-8v4h8zM100 74h4v-8h8v-4h-8v-8h-4v8h-8v4h8z" />
        </svg>
    ),
    nextjs: (
        <svg viewBox="0 0 128 128" className="w-full h-full">
            <circle cx="64" cy="64" r="64" fill="currentColor" />
            <path fill="#f8fafc" d="M106.317 112.014L49.167 38.4H38.4v51.179h8.614v-40.24l52.586 67.878a64.216 64.216 0 006.717-5.203zM81.778 38.4h8.533v51.2h-8.533z" />
        </svg>
    ),
};
    ...
    return (
        ...
        >
            ...
            <div className="relative w-full max-w-4xl mx-auto px-4">
                ...
                >
                    <FloatingIcon icon="html" className="left-[10%] top-[20%]" delay={0} />
                    <FloatingIcon icon="react" className="right-[15%] top-[15%]" delay={1} />
                    <FloatingIcon icon="java" className="left-[5%] bottom-[30%]" delay={2} />
                    <FloatingIcon icon="csharp" className="right-[10%] bottom-[25%]" delay={3} />
                    <FloatingIcon icon="nextjs" className="left-[20%] top-[10%]" delay={4} />
                </div>
